...
//
//  ALL CREDIT GOES TO:
//  https://stackoverflow.com/a/43193583/1311272
//
...
public struct RIPEMD160 {
    ...
    fileprivate var MDbuf: (UInt32, UInt32, UInt32, UInt32, UInt32)
    fileprivate var buffer: Data
    fileprivate var count: Int64 // Total # of bytes processed.
