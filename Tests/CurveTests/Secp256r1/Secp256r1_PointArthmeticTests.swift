...
class Secp256r1_PointArthmeticTests: XCTestCase {
    ...
    func testSecp256r1TestVector1() {
        ...
        XCTAssertEqual(publicKey.hex.compressed, "04ED4AB8839C65C65A88F0F288ED9C443F9C5488323E61ED7DBB8EDF9BE6B1746D3E13BE2FFCB19403A761420B1D26AF55E265A6F924FE0B7174D4D3654249092F")


        XCTAssertEqual(publicKey.point.x.asHexStringLength64(), "0ED4AB8839C65C65A88F0F288ED9C443F9C5488323E61ED7DBB8EDF9BE6B1746D")
    ...
    func testSecp256r1TestVector2() {
        ...
        XCTAssertEqual(publicKey.hex.compressed, "04B14C55CE9E942E7439171EBDFFBCFFE8ED0C933475AEC792B0D48EC1829EA2065598091915EFFA6F181D3EC8B4374806247081684C822D622DDE241288B9F0B4")

        XCTAssertEqual(publicKey.point.x.asHexStringLength64(), "0B14C55CE9E942E7439171EBDFFBCFFE8ED0C933475AEC792B0D48EC1829EA206")
    ...
    func testSecp256r1TestVector3() {
        ...
        XCTAssertEqual(publicAddress.point.x.asHexStringLength64(), "EAD218590119E8876B29146FF89CA61770C4EDBBF97D38CE385ED281D8A6B230")

        XCTAssertEqual(publicAddress.point.y.asHexStringLength64(), "28AF61281FD35E2FA7002523ACC85A429CB06EE6648325389F59EDFCE1405141")
