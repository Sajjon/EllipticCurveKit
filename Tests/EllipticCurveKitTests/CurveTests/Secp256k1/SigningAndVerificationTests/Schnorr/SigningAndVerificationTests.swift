...
final class SigningAndVerificationTests: XCTestCase {
...
private extension SigningAndVerificationTests {
    ...
    func signingAndVerifyingSignaturesTest(privateKey priHex: String, compressedPublicKey: String, uncompressedPublicKey: String? = nil, message: Message, expectedSignature: Signature<Secp256k1>, k: String? = nil) {
    ...
    func signingAndVerifyingSignaturesTest(privateKey priHex: String, compressedPublicKey: String, uncompressedPublicKey: String? = nil, message mHex: String, s: String, r: String, k: String) {
    ...
    func signingAndVerifyingSignaturesTest(privateKey priHex: String, compressedPublicKey: String, rawMsg: String, sig: String) {
    ...
    func signingAndVerifyingSignaturesTest(privateKey priHex: String, compressedPublicKey: String, msgHex: String, sig: String) {
