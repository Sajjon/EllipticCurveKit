...
class ECDSATests: XCTestCase {
    ...
    private func verifyRFC6979(_ privateKeyHex: String, _ messageToHash: String, _ expectedNonceKHex: String, _ hexForExpectedSignatureOn_DER_format: String) {
        ...
        XCTAssertEqual(hexForExpectedSignatureOn_DER_format, signatureFromMessage.asHexString(), "Must produce matching signature.")
    }
