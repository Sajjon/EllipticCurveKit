...
public extension Schnorr {
    ...
    static func sign(
        _ message: Message,
        using keyPair: KeyPair<CurveType>,
        personalizationDRBG: Data?
    ) -> Signature<CurveType> {
        ...
        let drbg = HMAC_DRBG(
            ...
            personalization: personalizationDRBG
        )
...
private extension Schnorr {
    ...
    static func hash<H>(
        ...
        let unhashedData: Data = q.prefix(compressedPubKey.byteCount) + compressedPubKey + message
