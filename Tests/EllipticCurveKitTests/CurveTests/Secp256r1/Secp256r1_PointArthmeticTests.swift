...
class Secp256r1_PointArthmeticTests: XCTestCase {
    ...
    func testSecp256r1TestVector1() {
        ...
        let ckPrivateKey = try! CryptoKit.P256.Signing.PrivateKey(rawRepresentation: Data(hex: "3D40F190DA0C18E94DB98EC34305113AAE7C51B51B6570A8FDDAA3A981CD69C3"))
        
        let ckPublicKey = ckPrivateKey.publicKey
        
        XCTAssertEqual(
            ckPublicKey.rawRepresentation.toHexString(),
            String(publicKey.hex.uncompressed.lowercased().dropFirst(2))
        )
