...
class CreatePublicKeyFromPrivateKeyTests: XCTestCase {
    ...
    func testCreatingPublicKeyAndAddressesFromPrivateKey() {
        ...
        let testnetAddress = PublicAddress<Secp256k1>(publicKeyPoint: publicKey, network: .testnet)
        ...
        let mainnetAddress = PublicAddress<Secp256k1>(publicKeyPoint: publicKey, network: .mainnet)
        ...
        let mainnetWifs = PrivateKeyWIF<Secp256k1>(privateKey: privateKey, network: .mainnet)
        ...
        let testnetWifs = PrivateKeyWIF<Secp256k1>(privateKey: privateKey, network: .testnet)
