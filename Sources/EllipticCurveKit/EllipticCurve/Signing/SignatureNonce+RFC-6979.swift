...
public extension PrivateKey {
    func drbgRFC6979<H>(message: Message, hashFunction: H) -> Number where H: HashFunction {
        return EllipticCurveKit.drbgRFC6979(privateKey: self, message: message, hashFunction: hashFunction)
    }
}
